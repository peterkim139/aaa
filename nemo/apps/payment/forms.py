...
class ConnectForm(forms.Form):
    ...
    CHOICES = (('', ''),
        ...
        ('NJ', 'New Jersey'),('NM', 'New Mexico'),('NY', 'New Yorek'),('NC', 'North Carolina'),('ND', 'North Dakota'),
    ...
    locality = forms.CharField(label='Locality', max_length=255, required=True, validators=[valdiate_lettersonly],
                           widget=forms.TextInput(attrs={'class': 'formControl'}), )
